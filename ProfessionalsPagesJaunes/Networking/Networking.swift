...
struct Networking {
    ...
    func getAccessToken<T: Codable>(endpoint: AppAPI, type: T.Type, completion: ((_ response: T) -> Void)?) {
        ...
        let body = "[\"grant_type\" : \"client_credentials\",  \"client_id\" : \"X74hmmhP7o5OwSCCa1i6ZMUYOXMCun0O\", \"client_secret\" : \"Azx0XeGMjtuts7rG\", \"audience\" : \"962a7976-f267-463e-855d-67779eed9ecd\"]"
